...
# # config for the template and static folders
...
# # Production database (comment out the above line and uncomment the below line)
# # app.config['SQLALCHEMY_DATABASE_URI'] = # production database likely postgresql TODO add production database

# # default secret key for development
# app.config["SECRET_KEY"] = "secret_key"

# # Production secret key (comment out the above line and uncomment the below line)
# # app.config['SECRET_KEY'] = # TODO add production secret key

# db = SQLAlchemy(app)

# # login manager config for flask-login
...
# # call this to update tables in the database
